...
В __kNN__ любые шумовые точки влияют на его работу. В __kwNN__ же результат лучше. 

__kNN__ очень часто плох в решении каких либо практических задач классификации.Он медленный и неточеный. 

__kwNN__ лучше __kNN__, тем что учитывает порядок соседей классифицируемого объекта, что улчшает качество классификации. 
